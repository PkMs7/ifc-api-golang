...
func (cs *CategoryService) GetCategoriesService() ([]*entity.Category, error) {
...
func (cs *CategoryService) CreateCategoryService(name string) (*entity.Category, error) {
...
func (cs *CategoryService) GetCategoryService(id string) (*entity.Category, error) {
